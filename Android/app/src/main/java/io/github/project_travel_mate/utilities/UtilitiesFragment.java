...
public class UtilitiesFragment extends Fragment implements CardViewOptionsAdapter.OnItemClickListener {
    ...
    public void onItemClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = SafetyMeasuresActivity.getStartIntent(mActivity);
                startActivity(intent);
                break;
            case 1:
                intent = ImportantContactsActivity.getStartIntent(mActivity);
                startActivity(intent);
                break;
            case 2 :
    ...
    private List<CardItemEntity> getUtilityItems() {
        ...
        cardEntities.add(
                new CardItemEntity(
                        ...
                        getResources().getString(R.string.text_safety)));

        cardEntities.add(
                new CardItemEntity(
                        getResources().getDrawable(R.drawable.importantcontacts),
                        getResources().getString(R.string.text_imp_contacts)));
//        cardEntities.add(
//                new CardItemEntity(
