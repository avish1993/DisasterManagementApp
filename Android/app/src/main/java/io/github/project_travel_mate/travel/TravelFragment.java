...
//                break;
            case 0:
                i = EvacuationSpotsActivity.getStartIntent(mActivity);
                startActivity(i);
                break;
            case 1:
                i = ServiceSpotsActivity.getStartIntent(mActivity);
                startActivity(i);
                break;
        }
    }
...
//                        getResources().getString(R.string.online_Shopping)));
        cardEntities.add(
                new CardItemEntity(
                        getResources().getDrawable(R.drawable.bus2),
                        getResources().getString(R.string.evacuation_spots)));
        cardEntities.add(
                new CardItemEntity(
                        getResources().getDrawable(R.drawable.hospital),
                        getResources().getString(R.string.service_spots)));
        return cardEntities;
    }
}
