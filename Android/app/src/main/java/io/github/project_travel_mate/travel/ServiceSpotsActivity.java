 ...
 */
public class ServiceSpotsActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_list_view :
                finish();
                Intent intent = ListViewRealTimeActivity.getStartIntent(ServiceSpotsActivity.this);
...
//                                break;
                        ...
                        ServiceSpotsActivity.this.getMarkers(HERE_API_MODES.get(which[i]), icon);
                    }
                    return true;
                })
    ...
    private void showMarker(Double locationLat, Double locationLong, String locationName, Integer locationIcon) {
        ...
        if (ContextCompat.checkSelfPermission(ServiceSpotsActivity.this,
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, ServiceSpotsActivity.class);
        return intent;
    }
    ...
    private void onMarkerSelected(Marker marker) {
        ...
        TextView title = ServiceSpotsActivity.this.findViewById(R.id.item_title);
        TextView description = ServiceSpotsActivity.this.findViewById(R.id.item_description);
        final Button calls, book;
        calls = ServiceSpotsActivity.this.findViewById(R.id.call);
        book = ServiceSpotsActivity.this.findViewById(R.id.book);
        ...
        calls.setOnClickListener(view -> {
            ...
            ServiceSpotsActivity.this.startActivity(intent);
        ...
        book.setOnClickListener(view -> {
            ...
            try {
                ...
                ServiceSpotsActivity.this.startActivity(browserIntent);
            } catch (Exception e) {
