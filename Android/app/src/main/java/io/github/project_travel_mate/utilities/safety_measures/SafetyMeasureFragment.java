 ...
 */
public class SafetyMeasureFragment extends Fragment {
     ...
     *
     * @param fact SafetyMeasure object
     * @return fragment object
     */
    public static SafetyMeasureFragment newInstance(SafetyMeasure fact) {
        SafetyMeasureFragment fragment = new SafetyMeasureFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        SafetyMeasure fact = (SafetyMeasure) Objects.requireNonNull(getArguments())
                .getSerializable(EXTRA_MESSAGE_FUNFACT_OBJECT);
        View view = inflater.inflate(R.layout.fragment_safety_measure, container, false);
