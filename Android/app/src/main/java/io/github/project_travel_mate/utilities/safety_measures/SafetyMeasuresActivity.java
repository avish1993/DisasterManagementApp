...
public class SafetyMeasuresActivity extends AppCompatActivity implements SafetyMeasuresView {
...
//  private City mCity;
    ...
    private void initPresenter() {
        SafetyMeasuresPresenter mPresenter = new SafetyMeasuresPresenter(this);
        //mPresenter.initPresenter(mCity.getId(), mToken);
        mPresenter.initPresenter("Cyclone", mToken);
    }
     ...
     */
    @Override
    public void setupViewPager(final ArrayList<SafetyMeasure> factsArray) {
        mHandler.post(() -> {
            List<Fragment> fList = new ArrayList<>();
            for (int i = 0; i < factsArray.size(); i++) {
                SafetyMeasure fact = new SafetyMeasure("Cyclone",
                        //factsArray.get(i).getImage(),
                        factsArray.get(i).getText());
                fList.add(SafetyMeasureFragment.newInstance(fact));
            }
            viewPager.setAdapter(new SafetyMeasuresActivity.MyPageAdapter(SafetyMeasuresActivity.this.
    ...
    /**
     * Sets adapter for SafetyMeasures
     */
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, SafetyMeasuresActivity.class);
