...
import static utils.Constants.HERE_API_MODES_2;
import static utils.Constants.USER_TOKEN;

/**
 * Show markers on map around user's current location
 */
public class EvacuationSpotsActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_list_view :
                finish();
                Intent intent = ListViewRealTimeActivity.getStartIntent(EvacuationSpotsActivity.this);
        ...
        new MaterialDialog.Builder(this)
                ...
                //    mGoogleMap.clear();
                    ...
                    for (int i = 0; i < which.length; i++) {
                        ...
                        EvacuationSpotsActivity.this.getMarkers(HERE_API_MODES_2.get(which[i]), icon);
                    }
                    return true;
                })
    ...
    private void showMarker(Double locationLat, Double locationLong, String locationName, Integer locationIcon) {
        ...
        if (ContextCompat.checkSelfPermission(EvacuationSpotsActivity.this,
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, EvacuationSpotsActivity.class);
        return intent;
    }
    ...
    private void onMarkerSelected(Marker marker) {
        ...
        TextView title = EvacuationSpotsActivity.this.findViewById(R.id.item_title);
        TextView description = EvacuationSpotsActivity.this.findViewById(R.id.item_description);
        final Button calls, book;
        calls = EvacuationSpotsActivity.this.findViewById(R.id.call);
        book = EvacuationSpotsActivity.this.findViewById(R.id.book);
        ...
        calls.setOnClickListener(view -> {
            ...
            EvacuationSpotsActivity.this.startActivity(intent);
        ...
        book.setOnClickListener(view -> {
            ...
            try {
                ...
                EvacuationSpotsActivity.this.startActivity(browserIntent);
            } catch (Exception e) {
